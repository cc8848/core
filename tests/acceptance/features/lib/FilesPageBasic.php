...
abstract class FilesPageBasic extends OwncloudPage {
	...
	public function enableShowHiddenFilesSettings() {
		...
		if (null === $showHiddenFilesCheckBox) {
			throw new ElementNotFoundException(
				__METHOD__ .
				" xpath $this->showHiddenFilesCheckboxXpath " .
