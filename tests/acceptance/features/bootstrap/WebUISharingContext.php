...
class WebUISharingContext extends RawMinkContext implements Context {
	...
	public function setMinCharactersForAutocomplete($minCharacters) {
		if (null === $this->oldMinCharactersForAutocomplete) {
	...
	public function allowHttpFallbackForFedSharing() {
		if (null === $this->oldFedSharingFallbackSetting) {
	...
	public function tearDownScenario() {
		...
		} elseif (null !== $this->oldMinCharactersForAutocomplete) {
			SetupHelper::runOcc(
				[
					'config:system:set',
					'user.search_min_length',
		...
		} elseif (null !== $this->oldFedSharingFallbackSetting) {
			SetupHelper::runOcc(
				[
					'config:system:set',
					'sharing.federation.allowHttpFallback',
